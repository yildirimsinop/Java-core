...
public class C01_PassByValue {
    ...
    /*
         - Kodlarimizin anlasilir olmasi icin main method'dan diger method'lara  parametre olarak
         gonderdigimiz variable'lar icin ayni isimli variable olusturmayi TERCIH EDERIZ.

         - Java method'lar arasinda gecis yaparken variable'i degil variable'nin value'sunu pass eder.
         Bu Java'nin Pass By Value'yu tercih etmesinden kaynaklaniyor.

         - Eger method'un icerisinde yaptiginiz degisikligin main method icin de gecerli olmasini
         isterseniz main method icerisinde
         fiyat = indiimUygula (fiyat);
    ...
    public static double indirimUygula(double fiyat) {
        ...
        fiyat = fiyat * 0.9; // fiyata atma yaptik kalici olarak 90 oldu
