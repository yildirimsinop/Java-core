...
public class C07_TamBolenlerListesi {
    public static void main(String[] args) {
        ...
        // Soru 6- Kullanicidan pozitif bir tamsayi alip, o tamsayiyi tam
        // bolebilen tum pozitif tamsayilari bir liste olarak bize donduren bir method olusturun.


        Scanner scan = new Scanner(System.in);

        System.out.println("Lutfen pozitif bolenlerini bulmak icin pozitif bir tamsayi giriniz : ");
