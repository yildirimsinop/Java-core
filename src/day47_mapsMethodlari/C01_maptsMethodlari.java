...
public class C01_maptsMethodlari {
    public static void main(String[] args) {
        ...
        /*
           putIfApsent(K,V) eger K daha once yoksa ekler ve null doner. Eger K daha once varsa, eklemek
           istedigimiz yeni degeri eklemek ve eski var olan degeri bize dondurur.
         */
