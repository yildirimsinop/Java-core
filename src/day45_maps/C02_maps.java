...
public class C02_maps {
    public static void main(String[] args) {
        ...
        /*
           Normalde bilgiler arasina Java ", kullanir. Biz de virgul kullanabilir
           Ancak bu durumda value Collection'inin kac elemanli olduguna dikkat etmemiz gerekir.
           Virgulle ayrilmis cok fazla element olabilir. Fakat Value'lerin bir butun olarak TEK BIR STRING oldugunu
           unutmamaliyiz.
