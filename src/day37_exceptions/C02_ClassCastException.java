...
public class C02_ClassCastException {
    public static void main(String[] args) {
        ...
        Short sayi3 = 24;
        // Integer sayi4 = sayi3; Integer ve Short arasinda parent-child iliskisi olmadigindan birbirine atama
        //                        yapilamaz
        ...
        System.out.println("Short datayi obje uzerinden Integer'a cevirince :" + sayi5); // (C02_ClassCastException.java:20)
    }
}
