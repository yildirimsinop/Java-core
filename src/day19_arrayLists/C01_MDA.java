...
public class C01_MDA {
    public static void main(String[] args) {
        ...
        int[] tomlamlarArrayi= new int[enKisaArrayLength];

        int indexdekiElementlerToplami = 0;

        for (int i = 0; i< tomlamlarArrayi.length; i++) {
            ...
            tomlamlarArrayi[i] = indexdekiElementlerToplami;
            indexdekiElementlerToplami=0;
        }

        System.out.println(Arrays.toString(tomlamlarArrayi));
    }
}
